...
<?php if ( have_comments() ) : ?>
	<section id="comments">
		<h6><?php comments_number(__('No Responses to', 'FoundationPress'), __('One Response to', 'FoundationPress'), __('% Review', 'FoundationPress') ); ?> &#8220;<?php the_title(); ?>&#8221;</h6>
...
<section id="respond">
	<h6><?php comment_form_title( __('Review kamu', 'FoundationPress'), __('Review kamu ke %s', 'FoundationPress') ); ?></h6>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p><input name="submit" class="button small tiny" type="submit" id="submit" tabindex="5" value="<?php esc_attr_e('Kirim komentar', 'FoundationPress'); ?>"></p>
